...
export default function ShortCloseModal({openShortClose,setOpenShortClose,response1,selectProgramCompleted,laser,setSelectProgramCompleted,setMachineProgramesCompleted}) {
    const handleClose=()=>{
