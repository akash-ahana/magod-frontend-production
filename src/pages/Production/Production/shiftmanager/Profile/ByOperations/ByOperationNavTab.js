...
export default  function ByOperationNavTab({programProcessing,proramCompleted,onClickMachine,onClickProgram,onClickOperation,setProgramCompleted,setProgramProcessing,onClickMachines,operation}) {
